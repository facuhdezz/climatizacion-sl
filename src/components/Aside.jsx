    ...
    return (
        <aside className="col-span-1 max-lg:hidden p-4 flex flex-col gap-5">
            <article className="text-md 2xl:text-lg flex flex-col gap-1">
                ...
                <Link to={"/calefactores"}><h3 className="bg-gray-200 rounded-lg px-2">Calefactores</h3></Link>
                <Link to={"/aires"}><h3 className="bg-gray-200 rounded-lg px-2">Aires acondicionados</h3></Link>
