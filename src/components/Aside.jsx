    ...
    return (
        <aside className="col-span-1 max-lg:hidden">
            <div className=' bg-white my-3 ml-3 rounded-lg p-4 flex flex-col gap-1'>
                <article className="text-base 2xl:text-lg flex flex-col divide-y divide-gray-400">
                    <Link to={"/"} className="hover:bg-gray-300"><h1 className="text-black font-semibold py-1 px-2 text-base 2xl:text-lg">Inicio</h1></Link>
