...
const CatBanner = () => {
    return (
        <section className="mt-6 flex flex-col">
            ...
            <article className="w-full h-32 bg-slate-400 relative overflow-hidden">
                <img className="object-cover object-top" src={Calefactor} />
                <div className='w-full h-24 absolute bottom-0 bg-gradient-to-t from-black to[rgba(0, 0, 0, 0)]'></div>
                <h1 className="absolute bottom-2 left-4 text-2xl font-bold text-white">Calefactores</h1>
            </article>
            <article className="w-full h-32 bg-slate-700 relative overflow-hidden">
                <img className="object-cover object-top" src={Aire} />
                <div className='w-full h-24 absolute bottom-0 bg-gradient-to-t from-black to[rgba(0, 0, 0, 0)]'></div>
