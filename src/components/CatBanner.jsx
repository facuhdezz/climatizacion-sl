    ...
    return (
        <section className="mt-6 lg:mt-10">
            ...
            <div className="flex flex-col sm:flex-row lg:gap-2">
                <Link to={"/calefactores"} className="w-full h-auto aspect-[2/1] bg-slate-400 relative overflow-hidden"><article>
                ...
                <Link to={"/aires"} className="w-full h-auto aspect-[2/1] bg-slate-700 relative overflow-hidden"><article>
