                ...
                <div className='flex flex-col justify-around items-center gap-6'>
                    ...
                    <div className="flex flex-col items-center text-center gap-2">
                        ...
                        <div className='flex items-center gap-2'>
                            <img className='h-6 hover:opacity-60 hover:cursor-pointer duration-200' src={Wpp} />
                            <img className='h-6 hover:opacity-60 hover:cursor-pointer duration-200' src={Ig} />
                            <img className='h-6 hover:opacity-60 hover:cursor-pointer duration-200' src={Fb} />
                        </div>
                    </div>
                </div>
            </div>
