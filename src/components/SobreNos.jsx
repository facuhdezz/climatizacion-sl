        ...
        <section className="flex flex-col gap-3 p-3 my-4">
            ...
            <div className="flex gap-2">
                <div>
                    ...
                    <p className="max-lg:hidden">El sistema conformado por un calefactor a pellet que cumpla con la normativa europea EN14785:2006 y pellets de madera certificados clase EN Plus A1 es uno de los sistema más eficientes del mercado y de menor costo operativo.
                ...
                <img className="w-28 h-auto" src='https://www.vivionhaus.com/uploads/cp_d96bddfb26821be262a5b65ba6082c8d.png' />
            </div>
        </section>
    );
}
